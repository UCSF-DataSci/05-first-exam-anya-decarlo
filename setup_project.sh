...
#Create Empty Python files in scripts directory 
...
- **scripts/**: A sub directory that contains Python scripts for the project tasks.
  ...
  - \`dna_operations.py\`:Performs complementation, reversal, and reverse complementation
...
- **results/**: A subdirectory directory that stores the output files from the analyses.
 ...
 >/Users/anyadecarlo@Anyas-Mac/Users/anyadecarlo/05-first-exam-anya-decarlo/bioinformatics_project/README.md
